...
def format_md_file(input_dir):
    ...
    for line in lines: 
        ...
        if len(line) > 1:
            ...
            # enum class 
            elif 'Class variables' in line:
                line = '### Class variables ' + '\n'
                lines_edit.append(line)

            # enum class
            elif 'Ancestors' in line:
                ancestor_index = lines.index(line)+2
                ancestor = lines[ancestor_index][6:]
                line = '### Ancestors ' + '\n'
                lines_edit.append(line)
                lines_edit.append(ancestor + '\n')
            ...
            # edit methods 
                ...
                # enum variables
                    ...
                    variable_index = line.index('`')+1
                    doc = '*' + line[variable_index:-2] + '*' + '\n'
                    lines_edit.append(doc + '\n')
            ...
            # find actual return and arguments contents for enum classes
...
if __name__ == "__main__":
    tar_directory = '/home/xuhan/OpenCDA/docs/pdocfile/opencda'
    transform_docs = []
    ...
    output_dir = '/home/xuhan/OpenCDA/docs/python_api_doc.md'
