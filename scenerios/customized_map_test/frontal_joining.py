...
def main():
    try:
        ...
        transform_point.location.x = transform_point.location.x + \
                                     0.87 * (all_deafault_spawn[2].location.x - all_deafault_spawn[11].location.x)
        transform_point.location.y = transform_point.location.y + \
                                     0.87 * (all_deafault_spawn[2].location.y - all_deafault_spawn[11].location.y)
        ...
        transform_5 = carla.Transform(carla.Location(x=-90.722836, y=7.500000, z=3.000000),
                                      carla.Rotation(pitch=0.000000, yaw=0, roll=0.000000))
        ...
        vehicle_5.apply_control(carla.VehicleControl(throttle=0.83))
