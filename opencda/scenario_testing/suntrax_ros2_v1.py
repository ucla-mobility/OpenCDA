    ...
    try:
        ...
        try:
            ...
            while rclpy.ok():
                ...
                # spin ROS2 nodes
                rclpy.spin_once(carla_data_subscriber, 
                                single_cav_subscriber, 
                                command_pubisher,
                                timeout_sec=0.05)
                # rclpy.spin_once(single_cav_subscriber, timeout_sec=0.05)
                # rclpy.spin_once(command_pubisher, timeout_sec=0.05)
                ...
                command_pubisher.publish_control_command(control)
