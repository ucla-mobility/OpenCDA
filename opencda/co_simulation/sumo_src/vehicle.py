...
class Vehicle():
    ...
    def __init__(self, vehicle):
        ...
        traci.vehicle.subscribeContext(
            self._name,tc.CMD_GET_VEHICLE_VARIABLE,
            self.sensorRange, [tc.VAR_SPEED, tc.VAR_POSITION, tc.VAR_LANE_ID, tc.VAR_LANE_INDEX, tc.VAR_SIGNALS])
    ...
    def getFollower(self, range = 20):
        return  traci.vehicle.getFollower(self.getName(), range)
